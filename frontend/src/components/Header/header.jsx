...
const header = () => {
    ...
    return (
        <>
            <div className={` dark:bg-slate-900 dark:text-white max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shodow-md bg-base-200 duration-300 translate-all ease-in-out" : ""}`}>
